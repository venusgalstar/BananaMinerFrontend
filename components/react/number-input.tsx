...
export default function QuantityInput({ onInputChange, onChange }) {
  return (
    <CustomNumberInput
...
const StyledInput = styled("input")(
  ...
  &:focus {
    ...
    box-shadow: 0 0 0 3px ${
      theme.palette.mode === "light" ? blue[500] : blue[200]
    };
  }
...
const StyledButton = styled("button")(
  ...
  border: 0;
  border-radius: 999px;
  color: ${theme.palette.mode === "light" ? blue[300] : blue[600]};
  ...
  &:hover {
    background: ${theme.palette.mode === "light" ? blue[800] : blue[100]};
    cursor: pointer;
  }
